...
export default function ExperienceTimeline() {
  ...
  return (
    <div 
      className="w-full max-w-[832px] mx-auto px-6 pb-16 border-b border-gray-200 dark:border-gray-800"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[var(--timeline-col)_1fr] gap-x-10 mb-6">
        <div className="hidden sm:block"></div>
        <div>
          <h3 className="text-2xl font-semibold leading-tight text-gray-900 dark:text-gray-50">
            Experience
          </h3>
        </div>
      </div>
          ...
          >
            ...
            <div className="min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-baseline sm:gap-3 gap-1 mb-2">
                ...
                <span className="text-[15px] sm:text-base text-gray-600 dark:text-gray-400">
                  at{" "}
                  {exp.companyLink ? (
                    <Link
                      ...
                      className="text-gray-600 dark:text-gray-400 underline decoration-gray-300 dark:decoration-gray-700 underline-offset-2 hover:decoration-gray-600 dark:hover:decoration-gray-400 transition-colors"
                    >
                      {exp.company}
                    </Link>
                  ) : (
